const data = [
    {
        title: 'Picnic',
        text: `Ravi and Rohit are good friends. They went on a picnic. They took the public bus. In the park, they saw a rabbit. It had a cute pink nose. They saw a squirrel. It was sitting next to a cactus plant. Then, they ate cutlets can cleaned their mouths with a napkin.`
    },
    {
        title: 'Math Problem',
    ...
    {
        title: 'Jungle',
        text: `I am on a trek in the jungle with my family. There were plenty of animals. Suddenly, it got cloudy and windy. The guide had a whistle around his neck to call people. He asked us all to cross the jungle quickly. This caused a bit of a hustle. We ran and ran, and were very quick to get out of the jungle.`
    },
    {
    ...
    {
        title: 'Walter and Wallet',
        text: `I call all my friends. We play basketball. I then recall that Walter has not come at all. We halt. We go and call Walter. He says he cannot come as he has lost his wallet and he almost starts to cry.`
    },
    {
        title: 'Maya went to Gym',
        text: `Maya has bread and milk in the morning. She wears her gym cap on her head. She goes to the gym. The gym teacher makes her sweat. While in the gym, her sweatshirt tears. She will have to fix it with thread, she thinks. Overall, Maya has fun at the gym.`
    },
    {
        title: 'Farm on Table',
