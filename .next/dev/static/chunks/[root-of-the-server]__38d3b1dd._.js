...
(()=>{
    const e = new Error("Cannot find module '../utils/apiService'");
            ...
            const initQuiz = {
                "McqAct.useEffect.initQuiz": async ()=>{
                    ...
                    try {
                        ...
                        const savedState = await apiService.getMcqProgress(currentUserId, activityId);
        ...
        "CompleteWordAct.useEffect": ()=>{
            ...
            const initGame = {
                "CompleteWordAct.useEffect.initGame": async ()=>{
                    ...
                    try {
                        const res = await fetch(`${API_BASE}/progress/${currentUserId}/${activityId}`);
                        if (res.ok) {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                !isSummary ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 231,
                    columnNumber: 11
                }, this) : /* SUMMARY AREA */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lz$2d$string$2f$libs$2f$lz$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lz-string/libs/lz-string.js [client] (ecmascript)"); // Still needed for the older iframes until we convert them all
...
//# sourceMappingURL=%5Broot-of-the-server%5D__38d3b1dd._.js.map